Feature: Manage triage
  ...
  # # * a user is created in test mode by default now
  # # * status changes to User::STATUS values on each subsequent update
  ...
  #   And user "senior1" <test_mode> in test mode
  #   When I visit "group1-admin" pending triage for group "group1"
  #   Then I should see <alert> alert for "senior1"
  #   
  #   Examples:
  #     | number     | alert     | group       | test_mode |
  #     | 1234567890 | normal    | safety_care | is not    |
  #     | 1234567890 | test mode | group1      | is        |
  #     |            | abnormal  | safety_care | is not    |
