...
class UserStoriesTest < ActionController::IntegrationTest
  ...
  #puts "hi how r u : #{devices(:madhu).id} "
    ...
    def test_fall
       ...
       curl_cmd ='curl -v -H "Content-Type: text/xml" -d "' + fall_event_xml + '" ' +'"' + "http://localhost:3000/falls?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" ' 
       puts curl_cmd
       system(curl_cmd)
 ...
 def test_panic
       ...
       panic_cmd ='curl -v -H "Content-Type: text/xml" -d "' + panic_event_xml + '" ' +'"' + "http://localhost:3000/panics?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" '
 ...
 def test_batterychargecomplete  
    ...
    batterycomplete_cmd ='curl -v -H "Content-Type: text/xml" -d "' + batterycomplete_event_xml + '" ' +'"' + "http://localhost:3000/battery_charge_completes?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" '
  ...
  def test_batterycritical  
      ...
      batterycritical_cmd ='curl -v -H "Content-Type: text/xml" -d "' + batterycritical_event_xml + '" ' +'"' + "http://localhost:3000/battery_criticals?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" '
  ...
  def test_batteryplugged
    ...
    batteryplugged_cmd ='curl -v -H "Content-Type: text/xml" -d "' + batteryplugged_event_xml + '" ' +'"' + "http://localhost:3000/battery_pluggeds?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" '
  ...
  def test_batteryunplugged
    ...
    batteryunplugged_cmd ='curl -v -H "Content-Type: text/xml" -d "' + batteryunplugged_event_xml + '" ' +'"' + "http://localhost:3000/battery_unpluggeds?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" '
  ...
  def test_strapremoved
    ...
    strapremoved_cmd ='curl -v -H "Content-Type: text/xml" -d "' + strapremoved_event_xml + '" ' +'"' + "http://localhost:3000/strap_removeds?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" '
  ...
  def test_strapfastened
    ...
    strapfastened_cmd ='curl -v -H "Content-Type: text/xml" -d "' + strapfastened_event_xml + '" ' +'"' + "http://localhost:3000/strap_fasteneds?gateway_id=#{devices(:madhu).id}&auth=1b092333716e1204c973ec651cab4a6470acbb29fa1e94fca20a2ccd6bdde82a"+'" '
