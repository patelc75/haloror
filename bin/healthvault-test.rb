#!/usr/bin/ruby
require 'healthvault'
require "#{RAILS_ROOT}/vendor/gems/rubyhealthvault-0.0.1/spec/support/test_server"
include HealthVault
...
Configuration.instance.cert_file =  "#{RAILS_ROOT}/config/halo_monitor-6019e8f1-413f-4dfc-878e-62053cbb0dab.pfx"

Configuration.instance.logger = Logger.new("#{RAILS_ROOT}/log/halo.hv.log")
