...
echo "httperf --server $server_name --add-header=\"content-type: text/xml\n\" --wsesslog $number_of_sessions,2,httperf-vitalspost --rate $number_of_sessions_per_second --ssl --ssl-no-reuse"
