  ...
  module Dates
      ...
      class Approxdatetime < ComplexType
        ...
        def initialize
          ...
          @children['structured'] = {:name => 'structured', :class => HealthVault::WCData::Dates::StructuredApproxDate, :value => nil, :min => 1, :max => 1, :order => 1, :place => :element, :choice => 61141343 }
            
          
        
          
          @children['descriptive'] = {:name => 'descriptive', :class => String, :value => nil, :min => 1, :max => 1, :order => 2, :place => :element, :choice => 61141343 }
