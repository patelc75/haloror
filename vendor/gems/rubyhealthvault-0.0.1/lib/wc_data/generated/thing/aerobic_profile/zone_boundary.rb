...
#<em>value</em> is a HealthVault::WCData::Thing::Types::Percentage
        ...
        def initialize
          ...
          @children['absolute-heartrate'] = {:name => 'absolute-heartrate', :class => String, :value => nil, :min => 1, :max => 1, :order => 1, :place => :element, :choice => 82796584 }
            
          
        
          
          @children['percent-max-heartrate'] = {:name => 'percent-max-heartrate', :class => HealthVault::WCData::Thing::Types::Percentage, :value => nil, :min => 1, :max => 1, :order => 2, :place => :element, :choice => 82796584 }
