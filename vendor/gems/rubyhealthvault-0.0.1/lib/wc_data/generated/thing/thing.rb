...
#<em>value</em> is a HealthVault::WCData::Types::String512
        ...
        #<em>value</em> is a HealthVault::WCData::Thing::DataOtherStream
        def data_other_stream=(value)
          @children['data-other-stream'][:value] = value
        end
        
        #<b>returns</b>: a HealthVault::WCData::Thing::DataOtherStream
        def data_other_stream
          return @children['data-other-stream'][:value]
        end
        ...
        def initialize
          ...
          @children['data-other-stream'] = {:name => 'data-other-stream', :class => HealthVault::WCData::Thing::DataOtherStream, :value => nil, :min => 0, :max => 1, :order => 12, :place => :element, :choice => 0 }
