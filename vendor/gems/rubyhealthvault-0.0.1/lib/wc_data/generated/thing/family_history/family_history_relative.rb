...
module HealthVault
  ...
  module Familyhistory
      ...
      class FamilyHistoryRelative < ComplexType
...
#<em>value</em> is a HealthVault::WCData::Dates::Approxdate
        ...
        def initialize
          super
          self.tag_name = 'familyhistoryrelative'
        
          
          @children['relative-name'] = {:name => 'relative-name', :class => HealthVault::WCData::Thing::Types::Person, :value => nil, :min => 0, :max => 1, :order => 1, :place => :element, :choice => 0 }
