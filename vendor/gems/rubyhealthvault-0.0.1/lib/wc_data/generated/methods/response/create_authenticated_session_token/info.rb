...
#<b>returns</b>: a HealthVault::WCData::Methods::Response::CreateAuthenticatedSessionToken::AppAuthTokenAbsenceReason Array
        ...
        def initialize
          ...
          @children['token'] = {:name => 'token', :class => HealthVault::WCData::Auth::Token, :value => Array.new, :min => 1, :max => 999999, :order => 1, :place => :element, :choice => 268029507 }
          
        
          
          @children['token-absence-reason'] = {:name => 'token-absence-reason', :class => HealthVault::WCData::Methods::Response::CreateAuthenticatedSessionToken::AppAuthTokenAbsenceReason, :value => Array.new, :min => 1, :max => 999999, :order => 2, :place => :element, :choice => 268029507 }
