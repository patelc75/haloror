...
#<em>value</em> is a HealthVault::WCData::Thing::Thing
        ...
        def initialize
          ...
          @children['external-id'] = {:name => 'external-id', :class => HealthVault::WCData::Types::Stringnz, :value => nil, :min => 1, :max => 1, :order => 3, :place => :element, :choice => 0 }
          ...
          @children['package'] = {:name => 'package', :class => HealthVault::WCData::Thing::Thing, :value => nil, :min => 1, :max => 1, :order => 4, :place => :element, :choice => 0 }
