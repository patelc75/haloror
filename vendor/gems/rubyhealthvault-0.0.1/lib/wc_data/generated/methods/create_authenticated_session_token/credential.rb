...
#<em>value</em> is a HealthVault::WCData::Auth::UserPassAuthSessionCred
        ...
        def initialize
          ...
          @children['cardspaceauthsession'] = {:name => 'cardspaceauthsession', :class => HealthVault::WCData::Types::CardSpaceCred, :value => nil, :min => 1, :max => 1, :order => 1, :place => :element, :choice => 394008559 }
            
          
        
          
          @children['appserver'] = {:name => 'appserver', :class => HealthVault::WCData::Types::AppServerCred, :value => nil, :min => 1, :max => 1, :order => 2, :place => :element, :choice => 394008559 }
            
          
        
          
          @children['userpassauthsession'] = {:name => 'userpassauthsession', :class => HealthVault::WCData::Auth::UserPassAuthSessionCred, :value => nil, :min => 1, :max => 1, :order => 3, :place => :element, :choice => 394008559 }
