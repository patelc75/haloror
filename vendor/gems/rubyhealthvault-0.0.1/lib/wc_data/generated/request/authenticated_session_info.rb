...
#<em>value</em> is a HealthVault::WCData::Request::OfflinePersonInfo
        ...
        def initialize
          ...
          @children['user-auth-token'] = {:name => 'user-auth-token', :class => String, :value => nil, :min => 0, :max => 1, :order => 2, :place => :element, :choice => 243703612 }
            
          
        
          
          @children['offline-person-info'] = {:name => 'offline-person-info', :class => HealthVault::WCData::Request::OfflinePersonInfo, :value => nil, :min => 0, :max => 1, :order => 3, :place => :element, :choice => 243703612 }
