...
#<em>value</em> is a HealthVault::WCData::Types::HashFinalized
        ...
        def initialize
          ...
          @children['app-id'] = {:name => 'app-id', :class => HealthVault::WCData::Types::Guid, :value => nil, :min => 1, :max => 1, :order => 5, :place => :element, :choice => 214375421 }
            
          
        
          
          @children['auth-session'] = {:name => 'auth-session', :class => HealthVault::WCData::Request::AuthenticatedSessionInfo, :value => nil, :min => 1, :max => 1, :order => 6, :place => :element, :choice => 214375421 }
