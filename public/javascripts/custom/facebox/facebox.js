...
var Facebox = Class.create({
	initialize	: function(extra_set){
		this.settings = {
			loading_image	: '/javascripts/custom/facebox/loading.gif',
			close_image		: '/javascripts/custom/facebox/closelabel.gif',
	        ...
	        <tbody> \
	          ...
	          <tr> \
	            ...
	            <td class="body"> \
	              ...
	              <div class="footer"> \
	                <a href="#" class="close"> \
	                  <img src="/javascripts/custom/facebox/closelabel.gif" title="close" class="close_image" /> \
	                </a> \
	              </div> \
	            </td> \
	            <td class="b"/> \
